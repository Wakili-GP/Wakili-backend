...
public static class UserErrors
{
    ...
    public static readonly Error LockedUser = new("User.LockedUser", "Locked User, Please contact your administrator", StatusCodes.Status403Forbidden);
    ...
    public static readonly Error EmailNotConfirmed = new("User.EmailNotConfirmed", "Email is not confirmed", StatusCodes.Status403Forbidden);
    public static readonly Error UserNotFound = new("User.NotFound", "No user was found with the given Id", StatusCodes.Status400BadRequest);
    ...
    public static readonly Error InactiveUser = new("User.Inactive", "Your account is inactive, Please contact support", StatusCodes.Status403Forbidden);
}